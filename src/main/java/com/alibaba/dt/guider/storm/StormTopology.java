package com.alibaba.dt.guider.storm;
...
import com.alibaba.dt.guider.storm.producer.Bolt;
import com.alibaba.dt.guider.storm.utils.StreamFileUtils;
...
public class StormTopology {
    ...
    public static void receiveMsg(int workerNum, int ackerNum, int ttPCSpoutNum, int ttAPPSpoutNum,
                                  ...
                                  int consumerThreadNum, String country, float ratioThreshold)
        ...
        TimeTunnelConfig ttApiRuleConfigPC = TimeTunnelConfig.loadConfigFromFile(tempFilePC
                .getPath());
        ...
        TimeTunnelConfig ttApiRuleConfigAPP = TimeTunnelConfig.loadConfigFromFile(tempFileAPP
                .getPath());
        ...
        MetaQPushSpout mqDelay = new MetaQPushSpout("ae_beacon_pageview_delay_30min",
        ...
        builder.setBolt("processor", new Bolt(properties, consumerThreadNum, ratioThreshold), boltNum)
    ...
    public static void main(String[] args) throws MQClientException, RemotingException,
            MQBrokerException, InterruptedException, AlreadyAliveException,
        ...
        //接收正常消息和延时消息
        receiveMsg(workerNum, ackerNum, ttPCSpoutNum, ttAPPSpoutNum, metaqDelaySpoutNum, boltNum,
                maxSpoutPending, consumerThreadNum, country, ratioThreshold);
    }
}
